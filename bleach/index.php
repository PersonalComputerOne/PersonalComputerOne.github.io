    ...
    <div class="row d-flex align-items-center justify-content-center h-100">
      ...
      <form action="conn.php" method="POST">
          ...
          <div class="d-flex justify-content-around align-items-center mb-4">
            ...
            <a href="uregister.php"><p class="create">Create a new one?</p></a>
          </div>
        ...
        <form action="admin.php" method="POST"><button type="submit" class="btn btn-primary btn-lg btn-block" name="admin">admin</button></form>
